...
var standardrouter = require('./standardRoutes');
var defineModel = require('./defineModel').defineModel;
...
class ServerME {
    ...
    createRoutes(route, dataSchema) {
        var dModel = new defineModel(dataSchema);
        //dModel.changeDataSchema();
        var intendedRouter = require('./standardRoutes');
        this.app.use(route, intendedRouter);
    }
}
